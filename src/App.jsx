...
function canViewAnnouncement(a, viewerProfile, myCourses) {
  if (!viewerProfile) return false;
...
export default function App() {
  ...
  const visibleAnnouncements = announcements.filter(a => canViewAnnouncement(a, user.profile, userData.courses));
