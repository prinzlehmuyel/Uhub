...
export default function App() {
  ...
  // Bump the shared item's view count once per successful load — anyone
  // (signed in or not) is allowed to touch just the `views` field.
  useEffect(() => {
    if (sharedItem && shareId && viewedShareRef.current !== shareId) {
  ...
  return (
    <div style={S.app}>
      ...
      {/* Arrived here via a Copy Link/Share link while already signed in
          ...
          same viewer used everywhere else in the app. */}
      {shareId && sharedItem && (
